...
namespace CancerClient.USpeak
{
	public class USpeakNative
	{
		...
		[DllImport("USpeakNative.dll", CallingConvention = CallingConvention.Cdecl)]
		private static extern Int32 Native_GetAudioFrame(IntPtr ptr, Int32 playerId, Int32 packetTime, byte[] bufferPtr, Int32 bufferLength);
		[DllImport("USpeakNative.dll", CallingConvention = CallingConvention.Cdecl)]
		private static extern Int32 Native_RecodeAudioFrame(IntPtr ptr, byte[] dataInPtr, Int32 dataInLength, byte[] bufferPtr, Int32 bufferLength);
		...
		public byte[] GetAudioFrame(Int32 playerId, Int32 packetTime)
		{
			lock (m_lock)
			{
				...
				Array.Copy(m_buffer, frame, nRead);
